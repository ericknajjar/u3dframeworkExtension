...
{
	internal class ValueBindingContext: IValueBindingContext
	{
		Dictionary<IBindingKey,IBinding> m_bindings = new Dictionary<IBindingKey,IBinding>(); 
		...
		public object Get(IBindingKey key, IBindingContext currentBindingContext)
		{
			IBinding ret = null;
			...
			throw new BindingNotFound(string.Format("Name: {0} Key: {1}",Name,key));
		}
